          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="bg-gradient-to-r from-green-600 to-green-700 p-6 text-center">
                ...
                <h1 className="text-2xl font-bold text-white mb-2">Listing Created Successfully!</h1>
                <p className="text-green-100">Your property listing has been added successfully</p>
              </div>
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
                  <div className="flex items-start">
                    ...
                    <div className="text-green-700 text-sm">
                      <p className="font-medium mb-1">Your listing is now live</p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-6">
            ...
            <form onSubmit={handleSubmit} className="p-6">
              ...
              {currentStep === 5 && (
                <div className="space-y-6">
                  <h2 className="text-xl font-semibold text-gray-900 mb-6">Review Listing</h2>
                  ...
                  <div className="bg-gray-50 rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className="font-medium text-gray-900">
                          {formData.type === 'sale' ? 'For Sale' : 'For Rent'}
                        </p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600">Location:</p>
                        <p className="font-medium text-gray-900">{formData.location}, {formData.city}</p>
                      </div>
                    </div>
                  </div>
